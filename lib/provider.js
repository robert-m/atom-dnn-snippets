...
module.exports = {
  selector: '.text.html.basic', // enable for HTML
  disableForSelector: '.text.html.basic .comment', // disable for comments
  ...
  isTagNameStartWithNoPrefix: function(arg) {
    ...
    return char === '<' && scopes.length === 1 && scopes[0] === 'text.html.basic';
  },
  ...
  isAttributeNameStartWithPrefix: function(arg) {
    ...
    return (scopes.indexOf('meta.tag.any.html') !== -1 || scopes.indexOf('meta.tag.no-content.html') !== -1) && char == ' ';
  },
  ...
  isAttributeValue: function(arg) {
    ...
    return (scopes.indexOf('string.quoted.double.html') !== -1 || scopes.indexOf('string.quoted.single.html') !== -1) && scopes.indexOf('meta.tag.any.html') !== -1;
  },
  ...
  getAllTagNameCompletions: function() {
    ...
    for (tag in ref) {
      completions.push({
        ...
        type: 'tag',
        description: tag,
        descriptionMoreURL: "https://www.google.com/search?q=" + tag,
        replacementPrefix: ''
      })
    }
